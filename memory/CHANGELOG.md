...
- Files affected: `ui/src/components/table/DataTable.astro`, `ui/src/components/table/advancedTable.ts`, `ui/src/components/table/partials/{DataTableToolbar,DataTableSearchExport,DataTableHead,DataTableFilters}.astro`, `ui/src/components/lib/FavoritesPill.astro`, `ui/src/components/lib/gallery/CardGallery.astro`, `ui/src/lib/catalogGallery.ts`, `ui/src/lib/catalogDetail.ts`, `ui/src/images/icons/funnel.svg`, `ui/src/pages/lib/{prompts,mcps,agents,propose}.astro`
