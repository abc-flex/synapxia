...
INSERT INTO actions (id, asset, user_id, type, workflow_status, content, parent) VALUES
    ...
    (1, 1, 1, 'PROPOSAL', 'HANDLED', NULL, NULL),
    (2, 1, 0, 'REVIEW', 'PENDING', NULL, NULL),
    (4, 1, 0, 'REVIEW', 'HANDLED', NULL, NULL),
    (5, 1, 1, 'PUBLICATION', 'PENDING', NULL, NULL),
    (7, 1, 1, 'PUBLICATION', 'HANDLED', NULL, NULL),
    ...
    (12, 4, 1, 'PROPOSAL',    'HANDLED', NULL, NULL),
    (13, 4, 0, 'REVIEW',      'PENDING', NULL, NULL),
    (15, 4, 0, 'REVIEW',      'HANDLED', NULL, NULL),
    (16, 4, 1, 'PUBLICATION', 'PENDING', NULL, NULL),
    (18, 4, 1, 'PUBLICATION', 'HANDLED', NULL, NULL),
    ...
    (24, 5, 2, 'PROPOSAL',    'HANDLED', NULL, NULL),
    (25, 5, 0, 'REVIEW',      'PENDING', NULL, NULL),
    (27, 5, 0, 'REVIEW',      'HANDLED', NULL, NULL),
    (28, 5, 2, 'PUBLICATION', 'PENDING', NULL, NULL),
    (30, 5, 2, 'PUBLICATION', 'HANDLED', NULL, NULL),
    ...
    (34, 6, 3, 'PROPOSAL',    'HANDLED', NULL, NULL),
    (35, 6, 0, 'REVIEW',      'PENDING', NULL, NULL),
    (37, 6, 0, 'REVIEW',      'HANDLED', NULL, NULL),
    (38, 6, 3, 'PUBLICATION', 'PENDING', NULL, NULL),
    (40, 6, 3, 'PUBLICATION', 'HANDLED', NULL, NULL),
    ...
    (46, 7, 1, 'PROPOSAL',    'HANDLED', NULL, NULL),
    (47, 7, 0, 'REVIEW',      'PENDING', NULL, NULL),
    (49, 7, 0, 'REVIEW',      'HANDLED', NULL, NULL),
    (50, 7, 1, 'PUBLICATION', 'PENDING', NULL, NULL),
    (52, 7, 1, 'PUBLICATION', 'HANDLED', NULL, NULL),
    ...
    (58, 8, 2, 'PROPOSAL',    'HANDLED', NULL, NULL),
    (59, 8, 0, 'REVIEW',      'PENDING', NULL, NULL),
    (61, 8, 0, 'REVIEW',      'HANDLED', NULL, NULL),
    (62, 8, 2, 'PUBLICATION', 'PENDING', NULL, NULL),
    (64, 8, 2, 'PUBLICATION', 'HANDLED', NULL, NULL),
    ...
    (67, 9, 3, 'PROPOSAL',    'HANDLED', NULL, NULL),
    (68, 9, 0, 'REVIEW',      'PENDING', NULL, NULL),
    (70, 9, 0, 'REVIEW',      'HANDLED', NULL, NULL),
    (71, 9, 3, 'PUBLICATION', 'PENDING', NULL, NULL),
    (73, 9, 3, 'PUBLICATION', 'HANDLED', NULL, NULL),
    ...
    (79, 10, 1, 'PROPOSAL',    'HANDLED', NULL, NULL),
    (80, 10, 0, 'REVIEW',      'PENDING', NULL, NULL),
    (82, 10, 0, 'REVIEW',      'HANDLED', NULL, NULL),
    (83, 10, 1, 'PUBLICATION', 'PENDING', NULL, NULL),
    (85, 10, 1, 'PUBLICATION', 'HANDLED', NULL, NULL),
    ...
    (91, 11, 2, 'PROPOSAL',    'HANDLED', NULL, NULL),
    (92, 11, 0, 'REVIEW',      'PENDING', NULL, NULL),
    (94, 11, 0, 'REVIEW',      'HANDLED', NULL, NULL),
    (95, 11, 2, 'PUBLICATION', 'PENDING', NULL, NULL),
    (97, 11, 2, 'PUBLICATION', 'HANDLED', NULL, NULL),
    ...
    (101, 12, 3, 'PROPOSAL',    'HANDLED', NULL, NULL),
    (102, 12, 0, 'REVIEW',      'PENDING', NULL, NULL),
    (104, 12, 0, 'REVIEW',      'HANDLED', NULL, NULL),
    (105, 12, 3, 'PUBLICATION', 'PENDING', NULL, NULL),
    (107, 12, 3, 'PUBLICATION', 'HANDLED', NULL, NULL),
