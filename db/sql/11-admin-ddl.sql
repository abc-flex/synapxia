...
CREATE TABLE refresh_tokens (
    token       VARCHAR(43)  NOT NULL,  -- secrets.token_urlsafe(32) → 43 chars
    user_id     BIGINT       NOT NULL,
...
ALTER TABLE bug_reports
    ADD CONSTRAINT fk_bug_reports_users
    FOREIGN KEY (user_id)
    REFERENCES users(id);
...
INSERT INTO modules (code, name, description, sort_order, icon) VALUES
    ...
    ('COLLAB', 'Collaboration',
     ...
     30, 'user-group'),
    ('LIB', 'AI Library',
     'Asset Library manages the reusable digital AI asset repository of SynapxIA, including prompt galleries, MCP catalogs, agents and related assets that can be discovered, governed, reused and evolved.',
     40, 'ai-library'),
    ('INITS', 'Initiatives',
