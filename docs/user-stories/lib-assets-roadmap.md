...
> Phase 3 (Related Assets, HU-LI07) is **shipped** (PR #56).
> Phase 4 (History, HU-LI10) is **shipped** (branch `feat/lib-assets-history`).
...
| 4 | PR4 | History / activity timeline | HU-LI10 | M | PR1, PR2 | ✅ shipped (`feat/lib-assets-history`) |
