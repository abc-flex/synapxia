...
- Files affected: `db/sql/12-admin-insert.sql`, `db/remediation/*` (removed), `api/app/lib/internal/propose_service.py`, `api/app/lib/routes/assets.py`, `api/app/lib/internal/models.py`, `api/tests/test_lib_propose.py`, `ui/src/pages/lib/propose.astro`, `ui/src/lib/propose.ts`, `ui/src/types/api.ts`, `ui/src/components/core/sidebar/SideBar.astro`, `ui/src/lib/toast.ts`, `ui/src/components/Toast.astro`, `ui/src/i18n/en.json`, `ui/src/i18n/es.json`
