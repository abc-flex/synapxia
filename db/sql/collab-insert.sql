    ...
    VALUES (
        ...
        'List of GenAI Adoption Levels for Developers',
    ...
    VALUES
        ('GenAI Adoption for Devs', 'NO_USAGE',  'Github Copilot, Cursor, Windsurf or Antigravity not configured', 10, TRUE),
        ('GenAI Adoption for Devs', 'LOW',       'Chat used in query mode for small scripts and code suggestions', 20, TRUE),
